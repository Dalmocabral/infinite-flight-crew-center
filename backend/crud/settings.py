...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Infinite World Tour Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "World Tour",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "World Tour",
    ...
    "welcome_sign": "Welcome to the Crew Center Admin",

    # Copyright on the footer
    "copyright": "Infinite World Tour System",
    ...
    "order_with_respect_to": ["auth", "api.PirepsFlight", "api.Award"],
    ...
    "icons": {
        ...
        "api.CustomUser": "fas fa-user-pilot",
        "api.Award": "fas fa-trophy",
        "api.FlightLeg": "fas fa-plane-route",
        "api.PirepsFlight": "fas fa-fighter-jet",
        "api.AllowedAircraft": "fas fa-plane",
        "api.AllowedIcao": "fas fa-building",
        "api.UserAward": "fas fa-medal",
    },
